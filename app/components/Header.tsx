  ...
  return (
    <div className="w-full relative">
      <div
        className={`${
          active
            ? "dark:bg-opacity-50 dark:bg-gradient-to-b dark:from-gray-900 dark:to-black fixed top-0 left-0 w-full h-[80px] z-[80] border-b dark:border-[#ffffff11c] shadow-xl transition duration-500 "
          ...
          <div className="w-full h-[80px] flex items-center justify-between p-3">
            ...
            <div className="flex items-center">
              ...
              <div className="800px:hidden">
                <HiOutlineMenuAlt2
                  size={25}
                  className="cursor-pointer mr-4 dark:text-white text-black"
